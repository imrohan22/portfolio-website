...
function PortFolio({ portfolioData }) {
  ...
  return (
    <>
      <section
        className="py-5 border-bottom portfolio-section"
        id="portfolio-sites"
      >
        <div className="container px-5 my-5">
          <div className="row">
            <div className="mb-5 text-center">
              <h2 className="fw-bolder display-3 text-uppercase">
                Potrfolio Sites
              </h2>
            </div>
          </div>
            ...
            <React.Fragment key={index}>
              <div className="row portfolio-devider">
                <div className="col-md-6 mb-5 postfolio-img-section">
                  <Carousel
                    images={portfolio.sitePhotos?.reduce(
                      (acc, item) => [...acc, ...item.images],
                      []
                    )}
                  />
                  {/* {portfolio.sitePhotos.map((siteimg, index) => {
                    return siteimg.images.map((img, index) => {
                      if (siteImgBool) {
                        ...
                        return (
                          <div
                            className="w-100 mb-3 d-flex justify-content-end portfolio-img-box"
                            key={index}
                          >
                            <Image
                              src={img.url}
                        ...
                        return (
                          <div
                            className="w-100 mb-3 d-flex justify-content-start portfolio-img-box"
                            key={index}
                          >
                            <Image
                              src={img.url}
      ...
      <style jsx global>
        {`
          ...
          .postfolio-img-section,
          .postfolio-content-section {
            padding: 25px;
          }
