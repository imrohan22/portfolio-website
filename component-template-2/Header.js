...
function HeaderTemp2({ headerData, metaData }) {
  let count = 1;
    ...
    <>
      <nav className="navbar navbar-expand-lg ">
        <div className="container-fluid ">
          ...
          <div
            className={`collapse navbar-collapse ${menu} justify-content-end`}
          ...
          <div className="row gx-5 justify-content-center">
            <div className="col-lg-8">
              <div className="text-center my-5">
                <h1 className="display-2 fw-bolder mb-4 heading-title">
                  {headerData[1][0].title}
                </h1>
                <hr
                  style={{ borderColor: "#FFCC00", borderWidth: 2, opacity: 1 }}
                />
                <p className="pr-4" style={{ fontSize: 36, fontWeight: "700" }}>
                  {headerData[1][0].subtitle}
                </p>
                <p className="pr-4">{headerData[1][0].description}</p>
              </div>
            </div>
