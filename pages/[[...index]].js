...
export default function Home(props) {
  ...
  if (templateId == "Black") {
    ...
    WhychooseusTemp2 = dynamic(() =>
      import("../component-template-2/Whychooseus")
    );
    SpecializationTemp2 = dynamic(() =>
      import("../component-template-2/Specialization")
    );
    ...
    TestimonialTemp2 = dynamic(() =>
      import("../component-template-2/Testiminial")
    );
    GetIntouchTemp2 = dynamic(() =>
      import("../component-template-2/Getintouch")
    );
    PortFolioTemp2 = dynamic(
      () => import("../component-template-2/Portfolio"),
      { ssr: false }
    );
    ...
    <div>
      ...
      {templateId == "White" && (
        <>
          ...
          {/* {landingPageData?.viewData?.home && <HomeTemp2 />} */}
          {landingPageData.viewData?.howWeWork && (
            <HowweworkTemp2
...
export async function getServerSideProps(context) {
  ...
  const API_BASE_URL =
    "http://api.projecthero.in/gateway/public/" + api_key + "/portfolio";
  let data = "";
